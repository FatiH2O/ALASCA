...
public class SwitchOnCharger extends ES_Event implements ChargerEventI {

    private static final long serialVersionUID = 1L;

    public SwitchOnCharger(Time t) { super(t, null); }
    ...
    public void executeOn(AtomicModelI model) {
        ...
        c.setState(ChargerElectricityModel.ChargerState.ON, this.getTimeOfOccurrence());
    }
}
