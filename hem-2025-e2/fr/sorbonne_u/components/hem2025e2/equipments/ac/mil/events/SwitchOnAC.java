...
public class SwitchOnAC extends ES_Event implements ACEventI {

    private static final long serialVersionUID = 1L;

    public SwitchOnAC(Time t) {
        super(t, null);
    }
    ...
    public void executeOn(AtomicModelI model) {
        ...
        ac.setState(ACElectricityModel.ACState.ON, this.getTimeOfOccurrence());
    }
}
