...
import fr.sorbonne_u.components.hem2025e1.equipments.ac.connections.ACExternalControlConnector;
import fr.sorbonne_u.components.hem2025e1.equipments.ac.connections.ACExternalControlOutboundPort;
import fr.sorbonne_u.components.hem2025e1.equipments.ac.connections.ACInternalControlConnector;
import fr.sorbonne_u.components.hem2025e1.equipments.ac.connections.ACInternalControlOutboundPort;
import fr.sorbonne_u.components.hem2025e1.equipments.ac.connections.ACUserConnector;
import fr.sorbonne_u.components.hem2025e1.equipments.ac.connections.ACUserOutboundPort;

@RequiredInterfaces(required = {ACUserCI.class, ACInternalControlCI.class, ACExternalControlCI.class})
public class ACUnitTester
extends     AbstractComponent
{
    ...
    public synchronized void execute() throws Exception {
        ...
        try {
            this.doPortConnection(this.acUserPort.getPortURI(), AC.USER_INBOUND_PORT_URI, ACUserConnector.class.getCanonicalName());
            this.doPortConnection(this.acInternalControlPort.getPortURI(), AC.INTERNAL_CONTROL_INBOUND_PORT_URI, ACInternalControlConnector.class.getCanonicalName());
            this.doPortConnection(this.acExternalControlPort.getPortURI(), AC.EXTERNAL_CONTROL_INBOUND_PORT_URI, ACExternalControlConnector.class.getCanonicalName());

            this.runAllTests();

        } catch (Exception e) {
            this.logMessage("Le test a échoué avec une exception !");
            e.printStackTrace();
        }
    ...
    protected void runAllTests() {
        ...
        this.logMessage("Feature: Contrôler le refroidissement");
        this.logMessage("  Scenario: Démarrer et arrêter le refroidissement");
