...
import Charger_connections.ChargerControlJava4InboundPort;
...
public class Charger extends AbstractComponent
    ...
    @Override public  Measure<Double> getMaxChargingPower() throws Exception {
    	return implementation.getMaxChargingPower();
    	}
    @Override public  SignalData<Double> getChargeLevel() throws Exception {
    	return implementation.getChargeLevel();
    	}
    @Override public  Measure<Double> getCurrentPower() throws Exception {
