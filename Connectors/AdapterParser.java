...
public class AdapterParser {
    ...
    public static ControlAdapterDescriptor parse(File xmlFile) throws Exception {
        ...
        // methods : <internal> + autres balises spécifiques (upMode, setMode, etc.)
