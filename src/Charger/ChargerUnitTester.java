...
public class ChargerUnitTester extends AbstractComponent {
	...
	public synchronized void start() throws ComponentStartException {
		...
		try {
			...
			this.doPortConnection(this.controlPort.getPortURI(), Charger.CONTROL_INBOUND_PORT_URI,
					ChargerControlConnector.class.getCanonicalName());

			this.doPortConnection(this.userPort.getPortURI(), Charger.USER_INBOUND_PORT_URI,
